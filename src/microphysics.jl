...
function condensation_adjustment(mtile::ModelTile, colstart::Int64, colend::Int64, t::Int64)
    ...
    q_c_total = inv_mu_transform.(mu_c .+ mtile.ref_state.mubar[:,1])
    ...
    #mu_c .= @. mu_c + tau_r * q_cond / inv_mu_transform.(mu_c)
